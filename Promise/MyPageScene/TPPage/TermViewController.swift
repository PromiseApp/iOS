...
class TermViewController: UIViewController {
    ...
    private func attribute(){
        ...
        contentLabel.do{
            ...
            $0.text = """
            제1조(목적)
            이 약관은 WeMeet (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
            ...
            가족, 친구, 지인 등과의 약속을 지키기 위한 공유 서비스
