...
class ConfirmEmailAuthViewController: UIViewController {
    ...
    var timerSignalDisposeBag = DisposeBag()
    ...
    private func bind(){
        ...
        confirmEmailAuthViewModel.startTimer()
        ...
        confirmEmailAuthViewModel.timerSignal
                    .emit(onNext: { [weak self] timeString in
        ...
        reSendButton.rx.tap
            .subscribe(onNext: { [weak self] in
                ...
                self?.confirmEmailAuthViewModel.startTimer()
